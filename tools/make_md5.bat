...
rem base can not be updated by online


rem client
MakeMD5List -dst %temp% -src E:\proj_mingxing97\proj\client\Debug\client
copy %temp%\filemd5List.json E:\proj_mingxing97\proj\client\Debug\client\res\filemd5List.json
