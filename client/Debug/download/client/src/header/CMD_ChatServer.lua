...
chat_cmd.SUB_GC_PERSON_STATUS_NOTIFY    = 3                             --私人房信息状态
chat_cmd.SUB_GC_PERSONAL_ROOM_OWNER_RESULT = 4                          --解散房间
...
local ROOM_ID_LEN = 7
--房间管理列表玩家状态
chat_cmd.CMD_GC_PersonUserStatusNotify =
{
	{t = "dword",  k = "dwUserID"},                          --用户标识
	{t = "string", k = "szNickName", s = yl.LEN_ACCOUNTS},   --用户昵称
	{t = "dword",  k = "dwFaceID"},						     --头像ID
	{t = "dword",  k = "dwCustomID"},						 --头像ID
	{t = "byte",   k = "cbGameStatus"},						 --游戏状态
	{t = "word",   k = "wKindID"},							 --游戏标识
	{t = "word",   k = "wServerID"},						 --房间标识
	{t = "word",   k = "wTableID"},							 --桌子标识
	{t = "word",   k = "wChairID"},							 --椅子标识
	{t = "string", k = "szRoomID", s = ROOM_ID_LEN}          --房间ID
}

--刷新私人房信息
chat_cmd.CMD_GC_RefreshPersonRoomOwner = 
{
	{t = "string", k = "szRoomID", s = ROOM_ID_LEN}      --房间ID
}
