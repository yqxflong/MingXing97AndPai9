...
login.SUB_GP_BANK_DETAIL_RESULT         = 174                               --交易记录结果
...
{
	{k = "dwUserID", t = "dword"},                                      --用户 I D
	{k = "ITransferScore", t = "score"},                                --转账金币
	{k = "szPassword", t = "string", s = yl.LEN_MD5},                   --银行密码
	{k = "dwGameID", t = "string"},                                     --目标用户GameID
	{k = "szAccounts", t = "string", s = yl.LEN_NICKNAME},              --目标用户
	{k = "szMachineID", t = "string", s = yl.LEN_MACHINE_ID},           --机器序列
	{k = "szTransRemark", t = "string", s = yl.LEN_TRANS_REMARK},       --转账备注
}

--查询明细
login.CMD_GP_QueryBankDetail = 
{
	{k = "dwUserID", t = "dword"},              --用户 I D
	{k = "iPage", t = "dword"},                   --查询第几页
	{k = "iPageSize", t= "dword"},                --每页大小，缺省为10
}

--明细结果
login.CMD_GP_BankDetailResult = 
{
	{k = "dwTotal", t = "dword"},          --总共条目数
	{k = "dwSourceGameID", t = "dword"},
	{k = "dwTargetGameID", t = "dword"},
	{k = "lSwapScore", t = "score"},
	{k = "szDateTime", t = "string", s = 64},
	{k = "lNum", t = "dword"},             --编号
	{k = "bType", t = "byte"},             --转帐类型，0-转出，1-转进
	{k = "llFee", t = "score"},             --费用
}
...
login.CMD_MB_LogonOtherPlatform = 
{
	...
	{k = "zsCompellation", t = "tchar", s = yl.LEN_COMPELLATION},		--真实名字
	--连接信息
