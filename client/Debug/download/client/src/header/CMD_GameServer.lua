...
game_cmd.SUB_GR_TRANSFER_SCORE_REQUEST           = 5                       --转账操作
...
game_cmd.CMD_RP_S_SYSTIEM =
{
	...
	{k = "wMinute" , t = "word"},
	{k = "wSecond" , t = "word"},
	{k = "wMilliseconds" , t = "word"},
}


--一个回放记录的一部分
game_cmd.CMD_RP_S_OneRecord = 
{
	{k = "m_iRecordID", t = "int"},
	{k = "m_dwKindID", t = "int"},
	{k = "m_dwVersion", t = "int"},
	{k = "m_iRoomNum", t = "int"},
	{k = "m_nUserCount", t = "int"},
	{k = "m_StartTime", t = "table", d = game_cmd.CMD_RP_S_SYSTIEM},
}


--一个回放记录的一把牌的一部分
game_cmd.CMD_RP_S_OneRecord_OneTime = 
{
	{k = "m_iRecordID" , t = "int"},
	{k = "m_iRecordChildID" , t = "int"},
	{k = "m_iRoundNumber" , t = "int"},
	{k = "m_iRoundType" , t = "int"},
	{k = "m_PlayTime" , t = "table", d = game_cmd.CMD_RP_S_SYSTIEM},
	{k = "m_PaketCount" , t = "dword"},
}
