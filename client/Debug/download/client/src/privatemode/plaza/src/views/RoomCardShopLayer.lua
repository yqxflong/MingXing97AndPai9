...
function RoomCardShopLayer:ctor( tabParam )
    print("function RoomCardShopLayer:ctor( tabParam )==>")
...
function RoomCardShopLayer:initExchangeUI(csbNode)
    print("function RoomCardShopLayer:initExchangeUI(csbNode)==>")
...
function RoomCardShopLayer:initBuyUI(csbNode)
    print("function RoomCardShopLayer:initBuyUI(csbNode)==>")
    local exchangeUi = csbNode:getChildByName("exchange_panel")
    ...
    if nil ~= self.m_tabParam.item.bean and 0 ~= self.m_tabParam.item.bean then
        cc.Label:createWithTTF(string.formatNumberThousands(self.m_tabParam.item.bean,true,",").."游戏豆", "fonts/yuanti_sc_light.ttf", 24)
    ...
    if nil ~= self.m_tabParam.item.gold and 0 ~= self.m_tabParam.item.gold then
        ...
        cc.Label:createWithTTF(string.formatNumberThousands(self.m_tabParam.item.gold,true,",").."游戏币", "fonts/yuanti_sc_light.ttf", 24)
            :setAnchorPoint(cc.p(0.0,0.5))
            :move(144,y)
            :setTextColor(cc.c4b(255,255,0,255))
            :addTo(buyUi)
    ...
    -- 折扣
    self._txtDiscount = cc.Label:createWithTTF(self.m_discount .. "%折扣", "fonts/yuanti_sc_light.ttf", 24)
...
function RoomCardShopLayer:onButtonClickedEvent(tag, ref)
    print("function RoomCardShopLayer:onButtonClickedEvent(tag, ref)==>")
...
function RoomCardShopLayer:onSelectedEvent(tag,sender,eventType)
    print("function RoomCardShopLayer:onSelectedEvent(tag,sender,eventType)==>")
...
function RoomCardShopLayer:onEditEvent(event,editbox)
    print("function RoomCardShopLayer:onEditEvent(event,editbox)==>")
    if event == "began" then
...
function RoomCardShopLayer:onUpdateNum()
    print("function RoomCardShopLayer:onUpdateNum()==>")
...
function RoomCardShopLayer:onUpdatePrice()
    print("function RoomCardShopLayer:onUpdatePrice()==>")
...
function RoomCardShopLayer:onUserInfoChange( event )
    print("function RoomCardShopLayer:onUserInfoChange( event )==>")
...
function RoomCardShopLayer:onShopDetailCallBack(result,message)
    print("function RoomCardShopLayer:onShopDetailCallBack(result,message)==>")
    local bRes = false
