...
login.SUB_MB_QUERY_PERSONAL_ROOM_LIST = 210                             -- 创建房间列表
login.SUB_MB_QUERY_PERSONAL_ROOM_LIST_RESULT = 211                      -- 创建房间列表返回
...
login.SUB_MB_PERSONAL_ROOM_OWNER = 223                                  --获取房间管理列表
login.SUB_MB_PERSONAL_ROOM_OWNER_RESULT  = 224                          --房间管理列表结果

login.SUB_MB_USER_QUERY_LOCK_INFO = 226                                  --查询房间信息锁
login.SUB_MB_LOCK_INFO_RESULT  = 227                                     --查询房间信息锁结果
------
-- 消息结构
------
--查询用户锁表信息
login.CMD_MB_LockInfoQuery = 
{
    {k = "dwUserID", t = "dword"}  --请求用户
}

--查询结果
login.CMD_MB_QueryLockInfoResult = 
{
    {k = "dwUserID", t = "dword"},  --请求用户
    {k = "wKind", t = "word"},      --类型标识
...
-- 查询房间管理列表
login.CMD_MB_QeuryRoomManagementList = 
{
    -- 用户ID
    {t = "dword", k = "dwUserID"},
    -- 类型ID
...
{
    -- 配置信息
    {t = "table", k = "PersonalRoomInfo", d = private_struct.tagPersonalRoomInfo, l = {private_define.MAX_CREATE_SHOW_ROOM}}
}

-- 房间管理列表信息
login.CMD_MB_PersonalRoomForOwner = 
{
    -- 网络ID
    {t = "dword", k = "dwSocketID"},
    -- 用户ID
    {t = "dword", k = "dwUserID"},
    -- 房间类型
    {t = "dword", k = "dwKindID"},
    -- 配置信息
    {t = "table", k = "PersonalRoomForOwner", d = private_struct.tagPersonalRoomForOwner, l = {private_define.MAX_CREATE_PERSONAL_ROOM}}
}
