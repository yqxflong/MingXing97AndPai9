...
function ModifyFrame:onConnectCompeleted()
	cclog("function ModifyFrame:onConnectCompeleted() ==> ")
...
function ModifyFrame:onSocketEvent(main,sub,pData)
	...
	cclog("function ModifyFrame:onSocketEvent(main,sub,pData) ==> ")
...
function ModifyFrame:onGameSocketEvent(main,sub,pData)
	cclog("function ModifyFrame:onGameSocketEvent(main,sub,pData) ==> ")
end

function ModifyFrame:onSubOperateSuccess(pData)

	cclog("function ModifyFrame:onSubOperateSuccess(pData) ==> ")
...
function ModifyFrame:onSubOperateFailure(pData)
	...
	cclog("function ModifyFrame:onSubOperateFailure(pData) ==> ")
...
function ModifyFrame:onSubUserFaceInfoResult( pData )
	...
	cclog("function ModifyFrame:onSubUserFaceInfoResult(pData) ==> ")
...
function ModifyFrame:onSubQueryUserInfoResult( pData )
	cclog("function ModifyFrame:onSubQueryUserInfoResult(pData) ==> ")
...
function ModifyFrame:sendModifyUserInfo()
	cclog("function ModifyFrame:sendModifyUserInfo() ==> ")
	...
	ModifyUserInfo:pushstring(GlobalUserItem.getPwd_MD5(),yl.LEN_MD5)
...
function ModifyFrame:sendModifyLogonPass()
	...
	cclog("function ModifyFrame:sendModifyLogonPass() ==> ")
...
function ModifyFrame:sendModifyBankPass()
	cclog("function ModifyFrame:sendModifyBankPass() ==> ")
...
function ModifyFrame:sendAccountBinding()
	cclog("function ModifyFrame:sendAccountBinding() ==> ")
	...
	AccountBinding:pushstring(GlobalUserItem.getPwd_MD5(), yl.LEN_MD5)
...
function ModifyFrame:sendAccountRegisteBinding()
	cclog("function ModifyFrame:sendAccountRegisteBinding() ==> ")
...
function ModifyFrame:sendModifySystemFace( )
	cclog("function ModifyFrame:sendModifySystemFace() ==> ")
	...
	sysmodify:pushstring(GlobalUserItem.getPwd_MD5(), yl.LEN_MD5)
...
function ModifyFrame:sendBindMachine()
	cclog("function ModifyFrame:sendBindMachine() ==> ")
...
function ModifyFrame:sendQueryUserInfo()
	cclog("function ModifyFrame:sendQueryUserInfo() ==> ")
	...
	buffer:pushdword(GlobalUserItem.dwUserID)
	buffer:pushstring(GlobalUserItem.getPwd_MD5(), yl.LEN_MD5)
	cclog("ModifyFrame:sendQueryUserInfo===userid: " .. GlobalUserItem.dwUserID .. "=pwd: " .. GlobalUserItem.szDynamicPass)
...
function ModifyFrame:sendInputSpreader()
	cclog("function ModifyFrame:sendInputSpreader() ==> ")
...
function ModifyFrame:onModifyUserInfo(cbGender,szNickname,szSign)
	cclog("ModifyFrame:onModifyUserInfo(cbGender,szNickname,szSign) ==> ")
...
function ModifyFrame:onModifyLogonPass(szOld,szNew)
	cclog("function ModifyFrame:onModifyLogonPass(szOld,szNew) ==> ")
...
function ModifyFrame:onModifyBankPass(szOld,szNew)
	cclog("function ModifyFrame:onModifyBankPass(szOld,szNew) ==> ")
...
function ModifyFrame:onAccountBinding(szAccount,szPassword)
	cclog("function ModifyFrame:onAccountBinding(szAccount,szPassword) ==> ")
...
function ModifyFrame:onAccountRegisterBinding(szAccount, szPassword, szSpreader)
	cclog("function ModifyFrame:onAccountRegisterBinding(szAccount, szPassword, szSpreader) ==> ")
...
function ModifyFrame:onModifySystemHead( wFaceId )
	...
	cclog("function ModifyFrame:onModifySystemHead( wFaceId ) ==> ")
...
function ModifyFrame:onBindingMachine( cbBind, strpw )
	cclog("function ModifyFrame:onBindingMachine( cbBind, strpw ) ==> ")
...
function ModifyFrame:onQueryUserInfo()
	cclog("function ModifyFrame:onQueryUserInfo() ==> ")
...
function ModifyFrame:onBindSpreader( nSpreaderID )
	cclog("function ModifyFrame:onBindSpreader( nSpreaderID ) ==> ")
