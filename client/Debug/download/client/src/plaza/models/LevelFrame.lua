...
function LevelFrame:ctor(view,callbcak)
	...
	cclog("function LevelFrame:ctor(view,callbcak) ==> ")

	LevelFrame.super.ctor(self,view,callbcak)
end

function LevelFrame:onConnectCompeleted()
	cclog("function LevelFrame:onConnectCompeleted() ==> ")
...
function LevelFrame:onLoadLevel()
	cclog("function LevelFrame:onLoadLevel() ==> ")
...
function LevelFrame:sendLoadLevel()
	cclog("function LevelFrame:sendLoadLevel() ==> ")
	...
	GrowLevelQueryInfo:pushstring(string.upper(GlobalUserItem.getPwd_MD5()),yl.LEN_MD5)
...
function LevelFrame:onSocketEvent(main,sub,pData)
	cclog("function LevelFrame:onSocketEvent "..main.." "..sub)
...
function LevelFrame:onSubGrowLevelParameter(pData)
	cclog("function LevelFrame:onSubGrowLevelParameter(pData) ==> ")
...
function LevelFrame:onSubGrowLevelUpgrade(pData)
	...
	cclog("function LevelFrame:onSubGrowLevelUpgrade(pData) ==> ")
