...
function ShopDetailFrame:ctor(view,callbcak)
	cclog("function ShopDetailFrame:ctor(view,callbcak) ==> ")
...
function ShopDetailFrame:onConnectCompeleted() 
	cclog("============ShopDetail:onConnectCompeleted============")
	cclog("ConnectCompeleted oprateCode="..self._oprateCode)
...
function ShopDetailFrame:onSocketEvent(main,sub,pData)
	cclog("============ ShopDetail onSocketEvent ============")
	cclog("socket event:"..main.."#"..sub)
...
function ShopDetailFrame:onGameSocketEvent(main,sub,pData)
	cclog("function ShopDetailFrame:onGameSocketEvent(main,sub,pData) ==> ")

	if main == game_cmd.MDM_GR_PROPERTY then
		cclog("GameSocket ShopDetail #" .. main .. "# #" .. sub .. "#")
...
function ShopDetailFrame:onSubPropertyBuyResult(pData)
	cclog("============ ShopDetailFrame:onSubPropertyBuyResult ============")
...
function ShopDetailFrame:onSubPropertyUseResult(pData)
	cclog("============ ShopDetailFrame:onSubPropertyUseResult ============")
	...
	cclog("*propCount-"..propCount)
	cclog("*lSendLoveLiness-"..GlobalUserItem:readScore(pData))
	cclog("*lRecvLoveLiness-"..GlobalUserItem:readScore(pData))
	cclog("*lUseResultsGold-"..GlobalUserItem:readScore(pData))
...
function ShopDetailFrame:onSubPropertyFailure(pData)
	cclog("============ ShopDetailFrame:onSubPropertyFailure ============")
...
function ShopDetailFrame:onSubQueryBag(pData)
	cclog("============ ShopDetailFrame:onSubQueryBag ============")
	local userID = pData:readdword()
...
function ShopDetailFrame:onSubPropertyTransResult(pData)
	cclog("============ ShopDetailFrame:onSubPropertyTransResult ============")
	local userID = pData:readdword()
	...
	cclog("----------------------------")
	cclog("*userid-"..userID)
	cclog("*recvGameID-"..recvGameID)
	cclog("*propID-"..propID)
	cclog("*propCount-"..propCount)
	cclog("*type-"..wType)
	cclog("*name-"..szName)
	cclog("*code-"..nHandleCode)
	cclog("*tip-"..szTip)
...
function ShopDetailFrame:onSubQuerySend(pData)
	...
	cclog("function ShopDetailFrame:onSubQuerySend(pData) ==> ")
...
function ShopDetailFrame:sendPropertyBuy()
	cclog("function ShopDetailFrame:sendPropertyBuy() ==> ")
	...
	PropertyBuy:pushstring(GlobalUserItem.getPwd_MD5(),33)
...
function ShopDetailFrame:sendPropertyUseNoConnect(id,count)
	cclog("============ ShopDetailFrame:sendPropertyUseNoConnect ============")
...
function ShopDetailFrame:sendPropertyUse()
	...
	cclog("function ShopDetailFrame:sendPropertyUse() ==> ")
...
function ShopDetailFrame:sendQueryBag()
	...
	cclog("function ShopDetailFrame:sendQueryBag() ==> ")
...
function ShopDetailFrame:sendQuerySend()
	...
	cclog("function ShopDetailFrame:sendQuerySend() ==> ")
	...
	QueryBag:pushdword(GlobalUserItem.dwUserID)
	QueryBag:pushstring(GlobalUserItem.getPwd_MD5(),33)
...
function ShopDetailFrame:sendPropertyTrans()
	...
	cclog("function ShopDetailFrame:sendPropertyTrans() ==> ")
	...
	cclog("-------------------------------")
	cclog("*recvid-"..self._recvid)
	cclog("*id-"..self._id)
	cclog("*count-"..self._count)
	cclog("*nickname-"..self._nickname)
...
function ShopDetailFrame:onPropertyBuy(type,count,id,use)
	...
	cclog("function ShopDetailFrame:onPropertyBuy(type,count,id,use) ==> ")
	...
	if nil ~= self._gameFrame and self._gameFrame:isSocketServer() then
		...
		buffer:pushstring(GlobalUserItem.getPwd_MD5(),33)
...
function ShopDetailFrame:onPropertyUse(id,count)
	...
	cclog("function ShopDetailFrame:onPropertyUse(id,count) ==> ")
...
function ShopDetailFrame:onQueryBag()
	...
	cclog("function ShopDetailFrame:onQueryBag() ==> ")
	...
	if nil ~= self._gameFrame and self._gameFrame:isSocketServer() then
		...
		buffer:pushdword(GlobalUserItem.dwUserID)
		buffer:pushstring(GlobalUserItem.getPwd_MD5(),yl.LEN_PASSWORD)
		if not self._gameFrame:sendSocketData(buffer) then
...
function ShopDetailFrame:onPropertyTrans(itemid,type,recvid,nickname,count)
	cclog("function ShopDetailFrame:onPropertyTrans(itemid,type,recvid,nickname,count) ==> ")
...
function ShopDetailFrame:onQuerySend()
	...
	cclog("function ShopDetailFrame:onQuerySend() ==> ")
