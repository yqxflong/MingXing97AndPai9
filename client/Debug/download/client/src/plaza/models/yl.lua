...
yl.WIDTH								= G_WIDTH_GLVIEW
yl.HEIGHT								= G_HEIGHT_GLVIEW
...
--ip
yl.LOGONSERVER							    = G_URL_LOGINSERVER 
--port
yl.LOGONPORT							    = G_PORT_LOGINSERVER 
...
--friend_port
yl.FRIENDPORT							= G_PORT_FRIEND


--编译码
yl.VALIDATE 							= "12DF3212-86C9-484D-989D-A8D6C97902C0" --@compilation

--http请求链接地址
yl.HTTP_URL								= G_URL_HTTP
...
yl.SCENE_REPLAYMAIN					    = 35        --战绩主界面


yl.SCENE_GAME 							= 40        --子游戏场景
yl.SCENE_GAME_REPLAY					= 41        --子游戏回放场景
...
yl.SUB_CM_SYSTEM_MESSAGE					= 1				--系统消息
yl.SUB_CM_ACTION_MESSAGE					= 2				--动作消息
...
--回放
yl.SUB_GP_GAME_RECORD_TOTAL				= 621			--查询总记录
yl.SUB_GP_GAME_RECORD_CHILD				= 622			--查询一轮记录
yl.SUB_GP_GAME_RECORD_CHILD_DATA		= 623           --查询一把牌详细操作记录
yl.SUB_GP_GAME_RECORD_TOTAL_FINISH      = 631           --返回完结总
yl.SUB_GP_GAME_RECORD_CHILD_FINISH		= 632			--返回完结一轮
yl.SUB_GP_GAME_RECORD_CHILD_DATA_FINISH = 633			--返回一把牌详细操作完结
...
--游戏内广播通知
yl.NOTIFY_INGAME_BROADCAST              = "notify_ingame_broadcast"

--分享配置
yl.SocialShare =
{
	title 								= G_GAME_NAME, --@share_title_social
	content 							= G_SHARE_CONTENT, --@share_content_social
	url 								= yl.HTTP_URL,
...
yl.WeChat = 
{
	AppID 								= G_CONFIG_WECHAT.AppID, --@wechat_appid_wx
	AppSecret 							= G_CONFIG_WECHAT.AppSecret, --@wechat_secret_wx
	-- 商户id
	PartnerID 							= G_CONFIG_WECHAT.PartnerID, --@wechat_partnerid_wx
	-- 支付密钥					        
	PayKey 								= G_CONFIG_WECHAT.PayKey, --@wechat_paykey_wx
	URL 								= yl.HTTP_URL,
}
...
{
	-- 合作者身份id
	PartnerID							= G_CONFIG_AliPay.PartnerID, --@alipay_partnerid_zfb
	-- 收款支付宝账号						
	SellerID							= G_CONFIG_AliPay.SellerID, --@alipay_sellerid_zfb
	-- rsa密钥
	RsaKey								= G_CONFIG_AliPay.RsaKey, --@alipay_rsa_zfb
...
yl.AMAP = 
{
	...
	AmapKeyAndroid						= "534bc0e2935e705e679505c387d1c9fa", --@android_devkey_amap
}
...
function yl.getSubGameName(kindID)
	local ret = kindDic[kindID] or "UNKNOWN"
	return ret
end

--@获取游戏文件夹
local kindFolderDic = {}
kindFolderDic["6"]  		= "zhajinhua"
kindFolderDic["20"]  		= "paijiu"
kindFolderDic["25"] 		= "hkfivecardnew"
kindFolderDic["27"] 		= "oxnew"
kindFolderDic["36"] 		= "oxsixex"
kindFolderDic["100"] 		= "mingxing97"
kindFolderDic["102"] 		= "oxex"
kindFolderDic["104"] 		= "oxbattle"
kindFolderDic["118"] 		= "sicbobattle"
kindFolderDic["122"] 		= "baccaratnew"
kindFolderDic["140"] 		= "luxurycar"
kindFolderDic["200"] 		= "land"
kindFolderDic["360"] 		= "longcheng"
kindFolderDic["389"] 		= "sparrowhz"
kindFolderDic["401"] 		= "gobang"

function yl.getSubGameFolder(kindID)
	local ret = kindFolderDic[kindID]
	return ret
end
...
function yl.isNeedFangkaByKind(kindID)
	return fangkaDic[kindID] == 1
end

--@子游戏kind定义
yl.KINDID_HONGZHONG		= 389
yl.KINDID_LONGCHENG     = 360
yl.KINDID_LAND			= 200
yl.KINDID_NIUNIU		= 27
yl.KINDID_TIAN9 		= 20
yl.KINDID_ZHAJINHUA		= 6
...
function yl.getOxnewModeByID(id)
	return oxnew_mode[id]
end
...
--@zorder
yl.ZORDER = {}
yl.ZORDER.Z_HELP_WEBVIEW = 10
yl.ZORDER.Z_CHEAT_BTN    = 100
yl.ZORDER.Z_CHEAT_LAYER  = 100
...
------------------------常用颜色------------------------------
yl.G_COLOR_INPUT_FONT            =  cc.c3b(255,255,255)
yl.G_COLOR_INPUT_PLACEHOLDER     =  cc.c3b(206, 211, 255)