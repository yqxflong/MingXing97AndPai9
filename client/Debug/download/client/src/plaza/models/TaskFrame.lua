...
function TaskFrame:ctor(view,callbcak)
	...
	print("function TaskFrame:ctor(view,callbcak) ==> ")
...
function TaskFrame:getTaskInfo()
	...
	print("function TaskFrame:getTaskInfo() ==> ")
...
function TaskFrame:getTastList()
	...
	print("function TaskFrame:getTastList() ==> ")
...
function TaskFrame:updateTask(wTaskID, command)
	...
	print("function TaskFrame:updateTask(wTaskID, command) ==> ")
...
function TaskFrame:sortTaskList()
	...
	print("function TaskFrame:sortTaskList() ==> ")
...
function TaskFrame:onGameSocketEvent(main,sub,pData)
	...
	print("function TaskFrame:onGameSocketEvent(main,sub,pData) ==> ")
...
function TaskFrame:onSubTaskList(pData, filterKind)
	...
	print("function TaskFrame:onSubTaskList(pData, filterKind) ==> ")
...
function TaskFrame:onSubTaskInfo(pData)
	...
	print("function TaskFrame:onSubTaskInfo(pData) ==> ")
...
function TaskFrame:onSubTaskResult(pData)
	...
	print("function TaskFrame:onSubTaskResult(pData) ==> ")
...
function TaskFrame:onSubTaskGiveupResult(pData)
	print("function TaskFrame:onSubTaskGiveupResult(pData) ==> ")
end

--加载任务
function TaskFrame:sendTaskLoad()

	print("function TaskFrame:sendTaskLoad() ==> ")
...
function TaskFrame:sendTaskGiveup()
	...
	print("function TaskFrame:sendTaskGiveup() ==> ")
...
function TaskFrame:sendTaskTake()
	...
	print("function TaskFrame:sendTaskTake() ==> ")
...
function TaskFrame:sendTaskReward()
	...
	print("function TaskFrame:sendTaskReward() ==> ")
...
function TaskFrame:onTaskLoad()
	...
	print("function TaskFrame:onTaskLoad() ==> ")
...
function TaskFrame:onTaskGiveup(wTaskID)
	...
	print("function TaskFrame:onTaskGiveup(wTaskID) ==> ")
...
function TaskFrame:onTaskTake(wTaskID)
	...
	print("function TaskFrame:onTaskTake(wTaskID) ==> ")
...
function TaskFrame:onTaskReward(wTaskID)
	...
	print("function TaskFrame:onTaskReward(wTaskID) ==> ")
...
function TaskFrame:getLevel(wStatus)
	...
	print("function TaskFrame:getLevel(wStatus) ==> ")
