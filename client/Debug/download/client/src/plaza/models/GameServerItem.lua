...
function GameServerItem:ctor(pData)
	cclog("function GameServerItem:ctor(pData) ==> ")
...
function GameServerItem:onInit(pData)
	...
	cclog("function GameServerItem:onInit(pData) ==> ")

	if pData == nil then
		cclog("GameServerItem-onInit-null")
		return
	end
...
function GameServerItem:readScore(dataBuffer)
	...
	cclog("function GameServerItem:readScore(dataBuffer) ==> ")
