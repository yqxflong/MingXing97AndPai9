...
function CheckinFrame:onConnectCompeleted()
	...
	cclog("============CheckinFrame:: onConnectCompeleted============")
	cclog("CheckinFrame:onConnectCompeleted oprateCode="..self._oprateCode)
...
function CheckinFrame:onSocketEvent(main,sub,pData)
	cclog("============CheckinFrame:onSocketEvent============")
...
function CheckinFrame:onSubCheckinInfo(pData)
	cclog("============CheckinFrame:onSubCheckinInfo============")
	GlobalUserItem.wSeriesDate = pData:readword()
	cclog("wSeriesDate-"..GlobalUserItem.wSeriesDate)
	...
	for i=1,yl.LEN_WEEK do
		...
		cclog("lRewardGold["..i.."]-"..GlobalUserItem.lRewardGold[i])
	end
...
function CheckinFrame:onSubCheckinResult(pData)
	...
	cclog("============CheckinFrame:onSubCheckinResult============")
	GlobalUserItem.bTodayChecked = pData:readbool()
...
function CheckinFrame:onSubGetMemberGift(pData)
	cclog("============ CheckinFrame:onSubGetMemberGift ============")

	local bSuccessed = pData:readbool()
	local szTip = pData:readstring()

	cclog("Gift tips " .. szTip)
	if nil ~= self._callBack then
...
function CheckinFrame:onSubGetVipPresent(pData)
	cclog("============ CheckinFrame:onSubGetVipPresent ============")
	local bSuccessed = pData:readbool()
...
function CheckinFrame:onSubBaseEnsureParam( pData )
	...
	cclog("============CheckinFrame:onSubBaseEnsureParam============")
	local tab = {}
...
function CheckinFrame:sendCheckinDone()
	...
	cclog("function CheckinFrame:sendCheckinDone() ==> ")
...
function CheckinFrame:sendCheckMemberGift()
	...
	cclog("function CheckinFrame:sendCheckMemberGift() ==> ")
	...
	CheckMemberGift:pushstring(GlobalUserItem.getPwd_MD5(),yl.LEN_PASSWORD)
...
function CheckinFrame:sendGetMemberGift()
	...
	cclog("function CheckinFrame:sendGetMemberGift() ==> ")
	...
	GetMemberGift:pushstring(GlobalUserItem.getPwd_MD5(),yl.LEN_PASSWORD)
...
function CheckinFrame:sendGetVipPresend()
	...
	cclog("function CheckinFrame:sendGetVipPresend() ==> ")
	...
	dataBuffer:pushstring(GlobalUserItem.getPwd_MD5(),yl.LEN_PASSWORD)
...
function CheckinFrame:sendBaseEnsureTake()
	...
	cclog("function CheckinFrame:sendBaseEnsureTake() ==> ")
	...
	BaseEnsureTake:pushstring(GlobalUserItem.getPwd_MD5(),yl.LEN_PASSWORD)
...
function CheckinFrame:sendBaseEnsureLoad()
	...
	cclog("function CheckinFrame:sendBaseEnsureLoad() ==> ")
...
function CheckinFrame:onCheckinQuery()
	...
	cclog("function CheckinFrame:onCheckinQuery() ==> ")
...
function CheckinFrame:onCheckinDone()
	...
	cclog("function CheckinFrame:onCheckinDone() ==> ")
...
function CheckinFrame:onCheckMemberGift()
	...
	cclog("function CheckinFrame:onCheckMemberGift() ==> ")
...
function CheckinFrame:onGetMemberGift()
	...
	cclog("function CheckinFrame:onGetMemberGift() ==> ")
...
function CheckinFrame:onBaseEnsureTake()
	...
	cclog("function CheckinFrame:onBaseEnsureTake() ==> ")
...
function CheckinFrame:onBaseEnsureLoad()
	...
	cclog("function CheckinFrame:onBaseEnsureLoad() ==> ")
	--操作记录
