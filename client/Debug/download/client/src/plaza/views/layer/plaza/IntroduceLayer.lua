...
function IntroduceLayer:ctor( scene, url )
    ...
    cclog("function IntroduceLayer:ctor( scene, url ) ==>")

    self._scene = scene
    url = url or yl.HTTP_URL
    -- 加载csb资源
    local rootLayer, csbNode = ExternalFun.loadRootCSB("plazanew/IntroduceLayer.csb", self )
...
function IntroduceLayer:onButtonClickedEvent(tag, ref)
    ...
    cclog("function IntroduceLayer:onButtonClickedEvent(tag, ref) ==>")
