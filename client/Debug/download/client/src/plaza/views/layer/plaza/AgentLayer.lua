...
function AgentLayer:onEnterTransitionFinish()
	...
	cclog("function AgentLayer:onEnterTransitionFinish()  ==>")
    return self
end

-- 退出场景而且开始过渡动画时候触发。
function AgentLayer:onExitTransitionStart()
	cclog("function AgentLayer:onExitTransitionStart()  ==>")
    return self
end

function AgentLayer:ctor(scene)

	cclog("function AgentLayer:ctor(scene)  ==>")
	local this = self
...
function AgentLayer:onButtonClickedEvent(tag,sender)
	cclog("function AgentLayer:onButtonClickedEvent(tag,sender)  ==>")
end

function AgentLayer:onSelectedEvent(tag,sender,eventType)
	cclog("function AgentLayer:onSelectedEvent(tag,sender,eventType)  ==>")
...
function AgentLayer:getURL(tag)
	cclog("function AgentLayer:getURL(tag)  ==>")
