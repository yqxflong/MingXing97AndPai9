...
function EveryDayLayer:onEnterTransitionFinish()
	...
	cclog("function EveryDayLayer:onEnterTransitionFinish() ==> ")
...
function EveryDayLayer:onExitTransitionStart()
	...
	cclog("function EveryDayLayer:onExitTransitionStart() ==> ")
...
function EveryDayLayer:ctor(scene)
	...
	cclog("function EveryDayLayer:ctor(scene) ==> ")
...
function EveryDayLayer:onUpdateShow()
	cclog("function EveryDayLayer:onUpdateShow() ==> ")
...
function EveryDayLayer:onButtonClickedEvent(tag,sender)
	...
	cclog("function EveryDayLayer:onButtonClickedEvent(tag,sender) ==> ")
...
function EveryDayLayer:onCheckinCallBack(result,message)
	cclog("======== EveryDayLayer:onCheckinCallBack ========")
...
function EveryDayLayer.cellSizeForTable(view, idx)
	...
	cclog("function EveryDayLayer.cellSizeForTable(view, idx) ==> ")
  	return 1161 , 508/4
end
...
function EveryDayLayer.numberOfCellsInTableView(view)
	...
	cclog("function EveryDayLayer.numberOfCellsInTableView(view) ==> ")
...
function EveryDayLayer.tableCellAtIndex(view, idx)
	...
	cclog("function EveryDayLayer.tableCellAtIndex(view, idx) ==> ")
	...
	if not cell then
    	...
    	--提示
		local clip = ClipText:createClipText(cc.size(720, 30), item.str, "fonts/yuanti_sc_light.ttf", 28)
		clip:setTag(3)
