...
function RankingListLayer:onEnterTransitionFinish()
	...
	cclog("function RankingListLayer:onEnterTransitionFinish() ==>")
...
function RankingListLayer:onExitTransitionStart()
	...
	cclog("function RankingListLayer:onExitTransitionStart() ==>")
...
function RankingListLayer:ctor(scene, preTag)
	...
	cclog("function RankingListLayer:ctor(scene, preTag) ==>")
	...
	self._myName = cc.Label:createWithTTF(string.stringEllipsis(GlobalUserItem.szNickName,self._enSize,self._cnSize,165),"fonts/yuanti_sc_light.ttf",24)
		:move(460,y)
...
function RankingListLayer:onUpdateShow()
	...
	cclog("function RankingListLayer:onUpdateShow() ==>")
...
function RankingListLayer:onButtonClickedEvent( tag, sender )
	...
	cclog("function RankingListLayer:onButtonClickedEvent( tag, sender ) ==>")
...
function RankingListLayer.cellSizeForTable(view, idx)
	...
	cclog("function RankingListLayer.cellSizeForTable(view, idx) ==>")
...
function RankingListLayer.numberOfCellsInTableView(view)
	cclog("function RankingListLayer.numberOfCellsInTableView(view) ==>")
...
function RankingListLayer.tableCellAtIndex(view, idx)
	...
	cclog("function RankingListLayer.tableCellAtIndex(view, idx) ==>")
	...
	if not cell then
		...
		cc.LabelAtlas:_create("0", "Rank/shuzi1.png", 16, 20, string.byte("0")) 
			...
			:addTo(cell)
		--昵称
		cc.Label:createWithTTF("游戏玩家","fonts/yuanti_sc_light.ttf",24)
			:move(305,cy)
			:setTag(5)
			:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
			:setAnchorPoint(cc.p(0,0.5))
...
function RankingListLayer.tableCellTouched(view, cell)
	cclog("function RankingListLayer.tableCellTouched(view, cell) ==>")
