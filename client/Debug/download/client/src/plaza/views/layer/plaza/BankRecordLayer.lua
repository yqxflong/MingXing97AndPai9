...
function BankRecordLayer:onEnterTransitionFinish()
	...
	cclog("function BankRecordLayer:onEnterTransitionFinish() ==> ")
...
function BankRecordLayer:onExitTransitionStart()
	cclog("function BankRecordLayer:onExitTransitionStart() ==> ")
...
function BankRecordLayer:ctor(scene)
	...
	cclog("function BankRecordLayer:ctor(scene) ==> ")
	...
	--无记录提示
	self._nullTipLabel = cc.Label:createWithTTF("没有银行记录","fonts/yuanti_sc_light.ttf",32)
			:move(yl.WIDTH/2,326)
...
function BankRecordLayer:onUpdateShow()
	cclog("function BankRecordLayer:onUpdateShow() ==> ")

	if not self._bankRecordList then
		cclog("self._nullTipLabel:setVisible(true)")
...
function BankRecordLayer.cellSizeForTable(view, idx)
	...
	cclog("BankRecordLayer.cellSizeForTable(view, idx) ==> ")
...
function BankRecordLayer.numberOfCellsInTableView(view)
	...
	cclog("function BankRecordLayer.numberOfCellsInTableView(view) ==> ")
...
function BankRecordLayer.tableCellAtIndex(view, idx)
	...
	cclog("function BankRecordLayer.tableCellAtIndex(view, idx) ==> ")
	...
	-- cclog(date)
	-- cclog(""..tonumber(item.date))
	cc.Label:createWithTTF(date,"fonts/yuanti_sc_light.ttf",32)
		:move(142,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(206,175,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(item.tradeType,"fonts/yuanti_sc_light.ttf",32)
		:move(412,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(206,175,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(string.formatNumberThousands(item.swapScore,true,","),"fonts/yuanti_sc_light.ttf",32)
		:move(612,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(206,175,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(item.id,"fonts/yuanti_sc_light.ttf",32)
		:move(812,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(206,175,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
	...
	cc.Label:createWithTTF(string.formatNumberThousands(item.revenue,true,","),"fonts/yuanti_sc_light.ttf",32)
		:move(1028,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(206,175,255,255))
		:setAnchorPoint(cc.p(0.5,0.5))
