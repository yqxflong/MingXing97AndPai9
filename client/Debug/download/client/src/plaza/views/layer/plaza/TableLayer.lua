...
function TableLayer:ctor(scene)
    ...
    cclog("function TableLayer:ctor(scene) ==>")
...
function TableLayer:onKeyBack( )
    ...
    cclog("function TableLayer:onKeyBack( ) ==>")
...
function TableLayer:onEnterTransitionFinish( )
    ...
    cclog("function TableLayer:onEnterTransitionFinish( ) ==>")
...
function TableLayer:onTouchBegan(touch, event)
    ...
    cclog("function TableLayer:onTouchBegan(touch, event) ==>")
...
function TableLayer:onTouchEnded(touch, event)
    ...
    cclog("function TableLayer:onTouchEnded(touch, event) ==>")
...
function TableLayer:onRequestTable()
    ...
    cclog("function TableLayer:onRequestTable() ==>")
...
function TableLayer:rotateTable( toKey )
    ...
    cclog("function TableLayer:rotateTable( toKey ) ==>")
...
function TableLayer:rotateTo( idx )
    ...
    cclog("function TableLayer:rotateTo( idx ) ==>")
	...
	cclog("rotate to " .. rotateParam[idx].angle)
...
function TableLayer:showPopWait()
    ...
    cclog("function TableLayer:showPopWait() ==>")
...
function TableLayer:dismissPopWait()
    ...
    cclog("function TableLayer:dismissPopWait() ==>")
