...
function CheckinLayer:onEnterTransitionFinish()
	...
	cclog("function CheckinLayer:onEnterTransitionFinish() ==> ")
...
function CheckinLayer:onExitTransitionStart()
	...
	cclog("function CheckinLayer:onExitTransitionStart() ==> ")
    return self
end

function CheckinLayer:onExit()
	cclog("function CheckinLayer:onExit() ==> ")
...
function CheckinLayer:ctor(scene)
	...
	cclog("function CheckinLayer:ctor(scene) ==> ")
	...
	cclog("*cbMemberOrder-"..GlobalUserItem.cbMemberOrder)
...
function CheckinLayer:onButtonClickedEvent(tag,sender)
	...
	cclog("function CheckinLayer:onButtonClickedEvent(tag,sender) ==> ")
...
function CheckinLayer:onCheckinCallBack(result, message, subMessage)
	...
	cclog("function CheckinLayer:onCheckinCallBack(result, message, subMessage) ==> ")
...
function CheckinLayer:reloadCheckin()
	cclog("function ====== CheckinLayer:reloadCheckin =======")
	...
	cclog("====== CheckinLayer:reloadCheckin =======")

end

function CheckinLayer:reloadGiftList( tabGift ,subMessage)

	cclog("function CheckinLayer:reloadGiftList( tabGift ,subMessage) ==> ")
...
function CheckinLayer:getGiftCount()
	...
	cclog("function CheckinLayer:getGiftCount() ==> ")
...
function CheckinLayer:onTouchBegan(touch, event)
	...
	cclog("function CheckinLayer:onTouchBegan(touch, event) ==> ")
...
function CheckinLayer:onTouchEnded( touch, event )
	...
	cclog("function CheckinLayer:onTouchEnded( touch, event ) ==> ")
...
function CheckinLayer:cellSizeForTable( view, idx )
	...
	cclog("function CheckinLayer:cellSizeForTable( view, idx ) ==> ")

	return self.m_fSix, 112
end

function CheckinLayer:numberOfCellsInTableView( view )
	cclog("function CheckinLayer:numberOfCellsInTableView( view ) ==> ")
	return self:getGiftCount()
end

function CheckinLayer:tableCellAtIndex( view, idx )

	cclog("function CheckinLayer:tableCellAtIndex( view, idx ) ==> ")
